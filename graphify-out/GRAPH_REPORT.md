...
- **What connects `Modèles Pydantic pour les sorties structurées des agents preproc.  - `AnalysisRe`, `Diagnostic d'une colonne.`, `Action recommandée par l'Agent Analyse.` to the rest of the system?**
